...
from ZServer.medusa.http_server import fifo, http_channel
...
class zhttp_handler(object):
    ...
    def get_environment(self, request,
        ...
        if hasattr(server.logger, 'resolver'):
            ...
            if env['REMOTE_ADDR'] in dns_cache:
...
class zhttp_channel(http_channel):
    ...
    def clean_shutdown_control(self, phase, time_in_this_phase):
        if phase == 3:
            ...
            # processing outstanding requests, and not accept any more
            ...
            if self.working or self.writable():
                ...
                # Close ourself and allow shutdown to proceed
                self.close()
                return 0
